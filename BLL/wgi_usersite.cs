...
namespace wgiAdUnionSystem.BLL
{
	...
	/// </summary>
	public class wgi_usersite
	{
		private readonly Iwgi_usersite dal=(Iwgi_usersite)DataAccess.CreateInstance("wgi_usersite");
		public wgi_usersite()
		{}
		#region  成员方法
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public wgiAdUnionSystem.Model.wgi_usersite GetModelByCache(int siteid)
		{
			...
			return (wgiAdUnionSystem.Model.wgi_usersite)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<wgiAdUnionSystem.Model.wgi_usersite> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<wgiAdUnionSystem.Model.wgi_usersite> DataTableToList(DataTable dt)
		{
			List<wgiAdUnionSystem.Model.wgi_usersite> modelList = new List<wgiAdUnionSystem.Model.wgi_usersite>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				wgiAdUnionSystem.Model.wgi_usersite model;
