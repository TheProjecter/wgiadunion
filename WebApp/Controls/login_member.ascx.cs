...
//public partial class Controls_login_member : System.Web.UI.UserControl
public partial class Controls_login_member : validateMember
{
    ...
    protected void btn_login(object sender, EventArgs e)
    {
        ...
        if (sessioncode.ToLower().Equals(txtCode.Text.ToLower()))
        {
            ...
            else
            {
                ...
                {
                    Response.Write("<script>alert('内部错误！');location.href='/member/default.aspx'</script>");
                }
                //Session["sid"] = uid;
