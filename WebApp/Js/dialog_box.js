...
function showDialog(title,message,type,autohide) {
  ...
  if (!document.getElementById('dialog')) {
	...
	dialogbottom.appendChild(dialogbutton);	
	...
	dialogbottom = document.getElementById('dialog-bottom');
 ...
 ///////
  ...
  dialogbottom.className = type;
  
  dialogbutton.className = "dialog-button";
  dialogbutton.innerHTML = "<button id='ok'>确&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;定</button>";  
  
  var content = document.getElementById(WRAPPER);
  dialogmask.style.height = content.offsetHeight + 'px';
 
  dialog.timer = setInterval("fadeDialog(1)", TIMER);
  if(autohide) {//////////erro hide button
