...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
	...
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtcontact" runat="server" Width="200px" MaxLength="30"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		电子邮件
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtmobile" runat="server" Width="200px" MaxLength="50"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		QQ
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtidcard" runat="server" Width="200px" MaxLength="50"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		通讯地址
