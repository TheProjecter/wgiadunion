<%@ Control Language="C#" AutoEventWireup="true" CodeFile="dashboard.ascx.cs" Inherits="admin_pages_dashboard" %>

<div id="content">
       			<div id="rightnow">
                    <h3 class="reallynow">
                        <span>Right Now<asp:Label ID="lbltest" runat="server">aa</asp:Label></span>
