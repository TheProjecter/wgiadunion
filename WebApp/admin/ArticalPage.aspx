<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArticalPage.aspx.cs" Inherits="admin_ArticalPage" ValidateRequest="false" %>
...
<form id="form" runat="server">
    <div id="box">
     <%--<div id="rightnow">
        ...
        <div class="youhave">
            <div id="tips">
                <asp:Label ID="lblapplyamt" runat="server" ForeColor="Red">text</asp:Label>
            </div>
        </div>
     </div>
     <br />--%>   
    <div>
    <p><b>公告标题：</b><asp:TextBox ID="txttitle" runat="server" MaxLength="100" Columns="50"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;<b>发送对象：</b><asp:DropDownList runat="server" ID="ddlobjtype"></asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;
