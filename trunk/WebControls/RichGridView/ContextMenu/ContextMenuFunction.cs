...
namespace Wgi.Web.UI.Controls.RichGridViewFunction
{
    ...
    public class ContextMenuFunction : ExtendFunction
    {
        ...
        public ContextMenuFunction(RichGridView sgv)
            : base(sgv)
        {
        ...
        protected override void Execute()
        {
            ...
            this._sgv.RenderBegin += new RichGridView.RenderBeginHandler(_sgv_RenderBegin);
            ...
            foreach (ContextMenu cm in this._sgv.ContextMenus)
            {
                ...
                this._menuItem += String.Format(",\"{0}\"", text.Replace(",", "，").Replace("$",","));
                this._target += String.Format(",\"{0}\"", target.Replace(",", "，").Replace("$", ","));
            }
